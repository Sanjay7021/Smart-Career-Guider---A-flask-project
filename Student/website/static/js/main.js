...
// const quiz = document.querySelector(".col-lg-7");
// const edit_quiz = document.querySelector(".col-lg-6");
// // const btn_quiz = document.querySelector(".btn-block");
...
//   edit_quiz.classList.remove('hidden');
//   var q_no = document.getElementById("street").value;
//   console.log(q_no);
//     var i =1;
//     while(i<=q_no)
//     {
...
//       document.write("Quiz added successfully!!!!!!");
